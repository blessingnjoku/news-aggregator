...
class Home extends React.Component{
  ...
  getNews=async()=>{
    const res= await fetch('https://newsapi.org/v2/top-headlines?country=ng&apiKey=f2b12a6becc84f6cb6fbbc38d0f8e957')
    ...
    <h3>Categories</h3>
        <div className="leftside-content">
          <a href="/Science">
           ...
           <div className="f-column ">
           <div className="leftside-flex entertainment">H</div>
           <span className="left-span">Hot Gist</span>
           </div>
            </a>
